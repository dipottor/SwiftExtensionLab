#
# Be sure to run `pod lib lint SwiftExtensionLab.podspec' to ensure this is a
...
Swift extensions for default classes like Array, Bool, Dictionary, Date, Timer, Color, AlertController, etc.
  ...
  s.source_files = 'SwiftExtensionLab/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SwiftExtensionLab' => ['SwiftExtensionLab/Assets/*.png']
  # }
